...
<head>
    ...
    <title>Silky White dress - Chic Style Boutique</title>
        ...
        <section class="product-details">
            <article class="product-container">
                ...
                <figure class="product-thumbnail">
                        <a href="../img/shop/DR6_large.png"><img src="../img/shop/DR6.png" alt="Silky White dress" title="Silky White dress"></a>
                </figure>

                <!-- Right: Product Information -->
                <section class="product-info">
                    <h2>Silky White dress</h2>
